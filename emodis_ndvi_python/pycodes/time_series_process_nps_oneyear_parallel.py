...
#jzhu, 8/7/2017, modified from time_series_process_nps_oneyear. Only difference is  time_series_process_nps_oneyear takes
# five arguments and time_series_process_nps_oneyear_parallel takes only one argument. The input argument is a tuple
# named t, this tuple defines (tmp, qd, bnames, threshold, and snowcld)
...
def time_series_process_nps_oneyear_parallel(t):
